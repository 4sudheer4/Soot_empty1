...
public class Main4 {
    ...
    public static void main(String[] args) {
        ...
        VM4Transformer mVM4Transformer = new VM4Transformer();


        Transform mVM4Transform = new Transform("wjtp.Malware", mVM4Transformer);
        PackManager.v().getPack("wjtp").add(mVM4Transform);
