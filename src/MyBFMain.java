...
public class MyBFMain {
    ...
    public static void main(String[] args) {
        ...
        MyBFTransformer mMyBFTransformer = new MyBFTransformer();


        Transform mMyBFTransform = new Transform("wjtp.Malware", mMyBFTransformer);
        PackManager.v().getPack("wjtp").add(mMyBFTransform);
